...
// const Header1 = ({ title = 'My Course', pageHeaderStyle={marginBottom:16}  }) => {
...
import { StyleSheet, View, Alert, TouchableOpacity, Animated } from 'react-native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useNavigation } from '@react-navigation/native';
import Heading from './Typography/Heading';
import { SvgXml } from 'react-native-svg';
...
const Header1 = ({ title = 'My Course', pageHeaderStyle = { marginBottom: 16 } }) => {
    ...
    return (
        <View style={[styles.pageHeader, pageHeaderStyle]}>
            <Animated.View style={[styles.pageTitleWrapper, { opacity: fadeAnim, transform: [{ translateY: translateYAnim }] }]}>
                <Heading title={title} />
            </Animated.View>
            <View style={styles.logoutButtonWrapper}>
                <TouchableOpacity onPress={confirmLogout}>
